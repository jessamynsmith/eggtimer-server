...
Generate graph of data models, e.g.:
    ...
    python3 manage.py graph_models --pygraphviz -a -g -o all_models.png  # all models
    python3 manage.py graph_models periods --pygraphviz -g -o period_models.png  # period models
...
curl -vk -X GET -H "Content-Type: application/json" -H 'Authorization: Token <AUTH_TOKEN>' "https://eggtimer.herokuapp.com/api/v2/statistics/" | python3 -m json.tool

curl -vk -X GET -H "Content-Type: application/json" -H 'Authorization: Token <AUTH_TOKEN>' "https://eggtimer.herokuapp.com/api/v2/periods/" | python3 -m json.tool

You can filter based on minimum and maximum timestamp of the events:

curl -vk -X GET -H "Content-Type: application/json" -H 'Authorization: Token <AUTH_TOKEN>' "https://eggtimer.herokuapp.com/api/v2/periods/?min_timestamp=2016-01-19&max_timestamp=2016-01-20" | python3 -m json.tool
...
Once your app is deployed successfully, you can add the Scheduler task on Heroku:
    ...
    python3 manage.py notify_upcoming_period --settings=eggtimer.settings
